...
procedure TfrmCadParamentros.actNovoExecute(Sender: TObject);
begin
  inherited;
  LimparTudo;
  vCodParams  :=  0;
...
begin
  ...
  begin
    ...
    vCampos   :=  vCampos   + 'DS_IMPRIMEORDEMSERV';
    ...
    vValores  :=  vValores  + GetCheckBoxSN(chkImprimeOrdem)         ;
  ...
  begin
    ...
    vValores  :=  vValores  + 'DS_IMPRIMEORDEMSERV = '  +
                  GetCheckBoxSN(chkImprimeOrdem)        ;
...
begin
  ...
  try
    ...
    begin
      ...
      chkImprimeOrdem.Checked :=  (FieldByName('DS_IMPRIMEORDEMSERV').AsString = 'S');
    end;
  except
