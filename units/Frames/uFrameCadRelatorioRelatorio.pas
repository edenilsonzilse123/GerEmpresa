...
type
  TfrmCadRelatorioRelatorio = class(TFrame)
    ...
    shpCorEscolhida: TShape;
    dlgColorRelat: TColorDialog;
    ...
    procedure btnBuscarCorClick(Sender: TObject);
    procedure SetCorBorba(pValor:TColor);
...
procedure TfrmCadRelatorioRelatorio.btnBuscarCorClick(Sender: TObject);
begin
  if dlgColorRelat.Execute then
    SetCorBorba(dlgColorRelat.Color)
  else
    SetCorBorba(clWhite);
end;
...
function TfrmCadRelatorioRelatorio.GetCorBorba: TColor;
begin
  Result  :=  shpCorEscolhida.Brush.Color;
end;
...
procedure TfrmCadRelatorioRelatorio.SetCorBorba(pValor: TColor);
begin
  shpCorEscolhida.Brush.Color :=  pValor;
  shpCorEscolhida.Pen.Color   :=  pValor;
end;
